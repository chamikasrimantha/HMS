<?php 
  ...
  class PDF extends FPDF
  {
    ...
    function body($info,$products_info){
      ...
      $this->SetX(10);
      $this->SetFont('Arial','B',12);
      $this->Cell(80,9,"Patient ID",1,0);
      $this->Cell(40,9,"Patient Name",1,0,"C");
      $this->Cell(30,9,"Phone No",1,0,"C");
      $this->Cell(40,9,"Patient Type",1,1,"C");
      $this->SetFont('Arial','',12);
    ...
    function Footer(){
      ...
      //Display Footer Text
      $this->Cell(0,10,"Arogya Health Care",0,1,"C");
